...
export function buildSchema() {
  ...
  const localBusiness = {
    ...
    description: `${business.name} provides same-day emergency AC repair, refrigerant leak repair, compressor repair, drain line clearing and seasonal HVAC tune-ups in Ocean Springs, Biloxi, Gautier and across Jackson and Harrison County, Mississippi. Licensed, bonded and insured with ${business.yearsInBusiness} on the Gulf Coast and ${rating.value} stars from ${rating.count} reviews. Average emergency response time ${business.responseTime}.`,
    url,
