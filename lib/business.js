...
export const business = {
  ...
  postalCode: "39564",
  serviceRegion: "Mississippi Gulf Coast",
  tagline: "Same-day emergency AC repair across the Mississippi Gulf Coast",
  valueProp:
...
// Hero copy — the business serves the whole coast, so the headline leads with
// the region and the city list does the local-SEO work underneath it.
export const hero = {
  headline: "AC Out? Same-Day Emergency AC Repair on the Mississippi Gulf Coast.",
  cities: [
    "Ocean Springs",
    "Biloxi",
    "Gautier",
  ...
  coverageLine: "plus all of Jackson & Harrison County, MS",
};
...
export const serviceArea = {
  headline: "Serving the Mississippi Gulf Coast",
  sub: "From Gulfport to Pascagoula — Jackson and Harrison County, covered end to end.",
...
export const faqs = [
  {
    ...
    a: `Same-day for most calls across the Mississippi Gulf Coast — Ocean Springs, Biloxi, Gautier, Gulfport and the surrounding Jackson and Harrison County areas. Average arrival is ${business.responseTime} after you call, and after-hours emergencies go straight to our on-call technician.`,
  },
  {
